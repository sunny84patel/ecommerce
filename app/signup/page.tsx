  ...
  return (
    <Container
      ...
      sx={{
        ...
        alignItems: "center",
        minHeight: "100vh",
        background: "linear-gradient(135deg, rgba(43,55,85,1) 0%, rgba(17,24,39,1) 100%)", // Dark gradient
      }}
    >
      <Paper
        elevation={3}
      ...
      >
        ...
        {/* Signup Form */}
        <Box component="form" onSubmit={handleSignup} sx={{ mt: 3, display: "flex", flexDirection: "column", gap: 2 }}>
          {/* Name Field */}
          <TextField
            label="Full Name"
            variant="outlined"
